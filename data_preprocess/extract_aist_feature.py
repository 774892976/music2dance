...
parser.add_argument(
    '--save_dir', type=str, default='/nvme/fengbin/music2dance/music2dance_data/aistpp_feature_mirror/extracted_motion_feature_20fps/',
    help='Path to the AIST wav files.')
parser.add_argument(
    '--smpl_dir', type=str, default='/nvme/fengbin/music2dance/music2dance_data/SMPL_python_v.1.1.0/smpl/models',
    help='Path to the AIST wav files.')
