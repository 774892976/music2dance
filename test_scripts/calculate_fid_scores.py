...
if __name__ == "__main__":
    ...
    extracted_motion_path = "[data_root]/extracted_motion_feature_20fps"
    output_path = ""
    anno_dir = "[data_root]/aist_plusplus_final"
    ...
    # set smpl
    smpl = SMPL(model_path="/nvme/fengbin/music2dance/music2dance_data/SMPL_python_v.1.1.0/smpl/models", gender='MALE', batch_size=1)
